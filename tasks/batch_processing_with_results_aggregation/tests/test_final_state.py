...
def test_batch_processing_results(start_trigger_dev):
    ...
    for _ in range(24):
        ...
        if run_status == "COMPLETED":
            ...
            assert output == 55 or (isinstance(output, dict) and 55 in output.values()), f"The aggregated sum is not correct, expected 55 (directly or in an object value), got: {output}"
            break
